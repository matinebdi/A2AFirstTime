    ...
    <footer className="bg-gray-900/95 backdrop-blur-sm text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold">VacanceAI</span>
            </div>
            <p className="text-gray-400 mb-4">
              Decouvrez des packages vacances tout compris avec l'aide de notre
              assistant IA. Des destinations de reve a portee de clic.
            </p>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; 2024 VacanceAI. Tous droits reserves.</p>
        </div>
      </div>
    </footer>
  );
